...
export const details: DetailItem[] = [
  ...
  {
    content: '<strong>RDS 커넥션 고갈 문제 진단 및 해결</strong>',
    subContents: [
      ...
      '<strong>코드 조치:</strong> fork 직후 부모 상속 커넥션 close 하도록 조치, task_prerun/postrun에 close_old_connections() 시그널 핸들러 추가, SQLAlchemy pool_size·max_overflow·pool_recycle 고정',
      '<strong>인프라 조치:</strong> RDS idle_session_timeout=15분 서버측 안전장치 지정, CloudWatch DatabaseConnections 2단계 알람 → Slack 알림으로 재발 방지',
    ],
  },
  {
    content: '<strong>Django 기반 도메인 분리 백엔드 설계 및 LLM 통합</strong>',
    subContents: [
  ...
  {
    content: '<strong>K3s 기반 자체 호스팅 인프라 및 비용 최적화</strong>',
    subContents: [
  ...
  {
    content: '<strong>서버리스 영상 분석 파이프라인 및 AI 시스템 구축</strong>',
    subContents: [
      'S3 → SNS fan-out → 다수 SQS → Lambda 기반 영상 처리 파이프라인 설계 및 Lambda Layer 공통 모듈화',
