...
export const details: DetailItem[] = [
  ...
  {
    content: '<strong>RDS Connection Exhaustion — Diagnosis & Resolution</strong>',
    subContents: [
      ...
      '<strong>Code fixes:</strong> made connections inherited from the parent process closed right after fork; added close_old_connections() signal handlers on task_prerun/postrun; pinned SQLAlchemy pool_size · max_overflow · pool_recycle.',
  ...
  {
    content: '<strong>Domain-segregated backend on Django with LLM integration</strong>',
    subContents: [
  ...
  {
    content: '<strong>Self-hosted infrastructure on K3s with cost optimization</strong>',
    subContents: [
  ...
  {
    content: '<strong>Serverless video analysis pipeline and AI systems</strong>',
    subContents: [
      'Designed an S3 → SNS fan-out → multiple SQS queues → Lambda-based video processing pipeline and shared common modules through a Lambda Layer.',
